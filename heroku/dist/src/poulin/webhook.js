    ...
    try {
        ...
        if (target === "general") {
            ...
            if (lowerMessage.includes("ciao") ||
                ...
                return {
                    content: "Ciao! Sono l'assistente virtuale de L'Altra Italia, specializzata in prodotti gastronomici mediterranei e italiani. Come posso aiutarti oggi?",
                    target: target,
                };
            }
                ...
                return {
                    content: "Posso aiutarti con informazioni sui nostri prodotti gastronomici mediterranei e italiani, servizi, o rispondere alle tue domande. Di cosa vorresti parlare?",
                    target: target,
                };
            }
        }
        ...
        if ((target === "orders" || target === "products" || target === "sales") &&
            ...
            if (target === "orders") {
                ...
                return {
                    content: "L'Altra Italia offre una vasta gamma di prodotti gastronomici mediterranei e italiani. Puoi visitare il nostro sito web per vedere il catalogo completo o chiedermi informazioni su categorie specifiche.",
                    target: target,
                };
            }
            else if (target === "sales") {
                return {
                    content: "Siamo felici che tu sia interessato ai prodotti gastronomici de L'Altra Italia. Posso fornirti informazioni generali sulle vendite o metterti in contatto con un nostro consulente.",
                    target: target,
                };
            }
        }
