...
const UpdatePromptHandler = async (req, res) => {
    ...
    try {
        ...
        console.error("Error updating prompt:", error instanceof Error ? error.message : error);
        res
            .status(500)
...
const GetPromptHandler = async (req, res) => {
    ...
    try {
        ...
        console.error("Error fetching prompt:", error instanceof Error ? error.message : error);
