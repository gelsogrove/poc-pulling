...
import { cleanResponse, executeSqlQuery, generateDetailedSentence, getPrompt, sendUsageData, } from "../share/chatbots_utility.js";
    ...
    try {
        ...
        try {
            ...
            if (sqlQuery !== null) {
                ...
                await sendUsageData(day, 0.2, "sales-reader", triggerAction, userId, idPrompt);
            }
            if (!sqlQuery) {
                res.status(200).json({
                    triggerAction,
