...
async function getAllUsers(req, res) {
    ...
    try {
        const result = await pool.query("SELECT userid, name,surname, role,username,isactive,last_connected FROM users ORDER BY name ASC");
...
async function updateUser(req, res) {
    ...
    try {
        const query = "UPDATE users SET name = $1, role = $2, username = $3, surname = $4, isactive = $5 WHERE userid = $6 RETURNING name, surname, username, role, isactive";
...
async function toggleUserActiveStatus(req, res) {
    ...
    try {
        const query = "UPDATE users SET isactive = $1 WHERE userid = $2 RETURNING name, surname, username, role, isactive";
