...
import { GetAndSetHistory, updateConversationHistory, } from "../../share/history.js";
import { validateRequest } from "../../share/validateUser.js";
import { getCoordinatorResponse, getPrompt, getTargetConfig, prepareFinalPayload, sendUsageData, } from "../../utility/chatbots_utility.js";
 ...
 */
export async function fetchSpecialistResponse(id, updatedHistory, chatbot) {
 ...
 */
const sendToWhatsapp = async (response, req) => {
    ...
    if (whatsappNumber) {
        try {
            ...
            await axios.post(`http://localhost:${process.env.PORT || 4999}/whatsapp/send`, {
                to: whatsappNumber,
                message: response,
            });
