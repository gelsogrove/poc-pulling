...
const handleResponse = async (req, res) => {
  ...
  `;
    ...
    const updatedHistory = await GetAndSetHistory(conversationId, idPrompt, userId, new Date(), message, "" // La prima volta sarà vuota, poi verrà recuperata dal DB
    );
    ...
    console.log("\n📩 OPENROUTER RAW RESPONSE:", JSON.stringify(openaiResponse.data, null, 2));
    ...
    console.log("\n📩 OPENROUTER RECEIVED:", JSON.stringify(openaiResponse.data.choices[0]?.message?.content, null, 2));
